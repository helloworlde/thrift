...
public class TSaslServerTransport extends TSaslTransport {
    ...
    public void addServerDefinition(String mechanism,
                                    ...
                                    Map<String, String> props,
                                    CallbackHandler cbh) {
        serverDefinitionMap.put(mechanism, new TSaslServerDefinition(mechanism, protocol, serverName, props, cbh));
    }
     ...
     * <p>
     * Serve 端的 SASL 协议消息处理，使用指定的机制创建 SASL 服务端，发送包返回给客户端
     */
    @Override
    ...
    private static class TSaslServerDefinition {
        ...
        public TSaslServerDefinition(String mechanism,
                                     String protocol,
                                     String serverName,
                                     Map<String, String> props,
                                     CallbackHandler cbh) {
    ...
    public static class Factory extends TTransportFactory {
         ...
         */
        public Factory(String mechanism,
                       String protocol,
                       String serverName,
                       Map<String, String> props,
                       CallbackHandler cbh) {
